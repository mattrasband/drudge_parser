...
@pytest.mark.parametrize('filename, top_count, main_count, col_count', (
    (os.path.join(static_dir, 'page01.html'), 13, 1, 53),
    (os.path.join(static_dir, 'page_2016_06_01.html'), 6, 1, 46),
))
def test_parse(filename, top_count, main_count, col_count):
    ...
    counter = {
        ...
        drudge_parser.Location.COLUMN: 0,
    }
    ...
    assert col_count == counter[drudge_parser.Location.COLUMN]
